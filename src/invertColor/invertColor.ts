 ...
 * @param options.bw - If true, returns black (#000000 or [0, 0, 0]) for light colors and white (#FFFFFF or [255, 255, 255]) for dark colors.
 * @returns The inverted color in the format which you passed the color param.
 */
